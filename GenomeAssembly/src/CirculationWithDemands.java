...
public class CirculationWithDemands {
    ...
    public static void main(String[] args){
        int vertexCount = 3;
        int edgeCount = 3;
        FlowNetworkGraph graph1 = new FlowNetworkGraph(vertexCount);
        graph1.addEdge(new FlowEdge(0, 1, 1, 3));
        graph1.addEdge(new FlowEdge(1, 2, 2, 4));
        graph1.addEdge(new FlowEdge(2, 0, 1, 2));
        ArrayList<String> vertexNameGraph1 = new ArrayList<String>(Arrays.asList("A", "B", "C"));
        int[] vertexDemandGraph1 = {0, 0, 0, 0};
