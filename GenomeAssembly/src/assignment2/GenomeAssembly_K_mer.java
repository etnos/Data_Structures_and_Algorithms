package assignment2;//Program to assemble Phi-X174 Genome from its K-Mer Composition.
...
public class GenomeAssembly_K_mer {
    ...
    private static void test() {
        ...
        String[] data = new String[]{"AAC", "ACG", "GAA", "GTT", "TCG"};

//        for (int i = 0; i < data.length; i++) {
//            graph[i] = new Vertex(i, data[i]);
//        }
